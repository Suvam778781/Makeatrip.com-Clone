...
export function Package({ packagedata, button, heading, dis }) {
    ...
    return (
        <div style={{ marginTop: "30px" }}>
            <Text fontSize={"10px"} display={dis} py="10px" textAlign={"left"} w="90%" margin={"auto"}><ChevronRightIcon color={"#55AAFF"} boxSize="24px" /> Exclusive Tours & Holiday Packages</Text>
            ...
            <Grid w="90%" m="auto" templateColumns={{ base: "repeat(1, 1fr)", sm: 'repeat(2, 1fr)', "lg": 'repeat(3, 1fr)', xl: 'repeat(3, 1fr)', "2xl": 'repeat(3, 1fr)' }} gap="9px">
                {!loading && data?.map((ele) =>
                    <VStack 
                        key={ele.id} lineHeight={"30px"} pb="10px" maxW='sm' borderRadius='lg' overflow='hidden'>
                        <Image data-aos="zoom-in" src={ele.image} alt={ele.image} />
    ...
    return (
        <VStack py={"100px"} lineHeight={"26px"} w="90%" textAlign={"left"} margin="auto">
            ...
            <Grid templateColumns={{ base: "repeat(1, 1fr)", sm: 'repeat(2, 1fr)', "lg": 'repeat(3, 1fr)', xl: 'repeat(3, 1fr)', "2xl": 'repeat(3, 1fr)' }} gap="20px" >
                <Image data-aos="zoom-in-down" borderRadius={"6px"} w="360px" src="https://cdn1.tripoto.com/media/filter/tst/img/1789711/Image/1597313001_coup.jpg" />
                <Image data-aos="zoom-in-down" borderRadius={"6px"} w="360px" src="https://cdn1.tripoto.com/media/filter/tst/img/1789711/Image/1597742263_f.jpg" />
                <Image data-aos="zoom-in-down" borderRadius={"6px"} w="360px" src="https://cdn1.tripoto.com/media/filter/tst/img/1789711/Image/1597312306_budget.jpg" />
            </Grid>
