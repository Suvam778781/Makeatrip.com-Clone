...
export default function Navbar({ position,image,ih="400px" ,text}) {
        ...
        <VStack h={ih} w="100%" backgroundImage={image} >
            <HStack style={position ? style2 : style1} h={"60px"} zIndex="20" px="30px" w={"100%"}>
                <HStack w="100px" my={"auto"} alignItems={"center"}>
                    ...
                    <Link href="/" _hover={{ textDecoration: "none", color: "gray" }} alignItems={"center"}><Image fontSize={"20px"} ml="-40px" textAlign={"center"} height={"100%"} width={{ "2xl": "260px" }} fontFamily={"cursive"} pl="20px" h={"60px"} src="https://i.ibb.co/02tZ9QP/makeatrip-logopng.png" /></Link>
                </HStack>
                ...
                <HStack fontSize={{ md: "14px", base: "12px", xl: "16px", "2xl": "18px", lg: "15px" }} py={"15px"} gap={{ md: "8px", lg: "11px", xl: "13px", "2xl": "15px" }}>
                    ...
                    <Link href="/package" _hover={{ textDecoration: "none", color: "gray" }} >Package</Link>
                    <Menu >
                    ...
                    <Link onMouseDown={onOpen} _hover={{ textDecoration: "none", color: "gray" }}>Sign In</Link>
                </HStack>
            </HStack>
            <VStack pt="150px">
